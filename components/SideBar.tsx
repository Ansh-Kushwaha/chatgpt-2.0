...
function SideBar() {
  ...
  session && 
    query(collection(dataBase, 'users', session.user?.email!, 'chats'),
  ...
  return (
    <div className="p-2 flex flex-col w-full h-screen text-white">
        <div className="flex-1 h-full justify-between">
          <div>
              {/* NewChat */}
              <NewChat />
              <div>
              ...
              <div className="w-full h-[75vh] overflow-y-auto my-3 short_scrollbar">
                {chats?.docs.map((chat) => (
          ...
          <div className="max-h-fit border-t align-bottom border-white/20 pt-2">
